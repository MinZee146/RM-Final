...
namespace Restaurant_Management_App.Model
{
    public partial class frmOrder : Form
    {
        ...
        {
            if (e.ColumnIndex != 4||billStatus=="Đã hoàn thành")
            {
                e.Cancel = true;
            }
        }
        ...
        private void btNew_Click(object sender, EventArgs e)
        {
            ...
            //btTakeAway.Enabled = true;
            //btDinIn.Enabled = true;
            pnProd.Enabled = true;
        ...
        public int id = 0;
        public string billType = "", billStatus = "", waiterName = "", tableName = "";
        private void btBill_Click(object sender, EventArgs e)
        {
            ...
            if (frm.mainID > 0)
            {
                ...
                if (billStatus == "Đã hoàn thành")
                {
                    ...
                    //btTakeAway.Enabled = false;
                    //btDinIn.Enabled = false;
        ...
        private void gunaDataGridView1_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
            if (billStatus == "Đã hoàn thành")
                e.Cancel = true;
        }
